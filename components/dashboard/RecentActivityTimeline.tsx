...
import { FileText, PlusCircle, Edit3, Trash2, Award } from "lucide-react";
    ...
    <div className="space-y-3">
      {activities.map((activity) => {
        ...
        return (
          <div
            key={activity.id}
            className="flex items-start gap-3 rounded-2xl border border-slate-200 p-3.5 transition hover:border-brand-200 dark:border-slate-800 dark:bg-slate-800/30 dark:hover:border-slate-700"
          >
