  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-navy-700 bg-navy-900 p-5 sm:p-6 shadow-soft transition text-slate-100">
        <p className="text-xs font-bold uppercase tracking-wider text-gold-400">Minha conta</p>
        <h1 className="mt-1 text-2xl font-black text-slate-100">Perfil do professor</h1>
        <p className="mt-1.5 text-sm text-slate-400">Atualize seus dados, altere sua senha e salve uma logo padrão da escola.</p>
      </section>
      ...
      <form className="card space-y-5" onSubmit={handleSubmit}>
        ...
        <div className="rounded-2xl border border-navy-700 bg-navy-850/40 p-4.5 transition">
          <h2 className="font-black text-slate-100">Alterar senha</h2>
          <p className="mt-1 text-xs text-slate-400">Deixe em branco caso não deseje trocar a senha.</p>
        ...
        <div className="rounded-2xl border border-dashed border-navy-700 p-4 transition">
          <label className="flex cursor-pointer flex-col items-center justify-center gap-3 rounded-xl bg-navy-950/60 p-5 text-center transition hover:bg-navy-850/60">
            {logoPreview ? (
            ...
            <span className="text-sm font-bold text-slate-200">Logo padrão da escola</span>
            <span className="text-xs text-slate-400">Será usada automaticamente na página Gerar Prova.</span>
